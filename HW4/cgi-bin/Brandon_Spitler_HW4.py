...
#function from http://stackoverflow.com/questions/13588697/getting-weather-conditions-using-python-im-confused-by-json-format
def getWeather(city):
	try:
...
#function from how-to-get-string-objects-instead-of-unicode-ones-from-json-in-python  --Mark Amery
def byteify(input):
...
#	print str(states_caps[key]['capital'])
	...
	''' 
	#text+=json.loads(getWeather(states_caps[key]['capital'])
	#text+="<br>"
#print "<br>"
#print text
import cgi, cgitb
